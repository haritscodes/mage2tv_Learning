...
return [
    'modules' => [
        ...
        'Learning_Contact' => 1,
        'Learning_DependencyInjection' => 1,
        'Learning_HeadCssJs' => 1,
        'Learning_HeaderFooterScripts' => 1,
        'Learning_InjectableNotInjectablesExample' => 1,
        'Learning_Layout' => 1,
        'Learning_Movelayout' => 1,
        'Learning_Removelayout' => 1,
        'Learning_ViewModelExample' => 1,
        'Learning_Widgets' => 1,
        'PayPal_Braintree' => 1,
